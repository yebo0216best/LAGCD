...
def get_datasets(dataset_name, train_transform, test_transform, args):
    ...
    vanilla_unlabelled = deepcopy(datasets['train_unlabelled'])
    vanilla_unlabelled.transform = test_transform
    vanilla_labelled = deepcopy(datasets['train_labelled'])
    vanilla_labelled.transform = test_transform
    vanilla_dataset = MergedDataset(labelled_dataset=vanilla_labelled, unlabelled_dataset=vanilla_unlabelled)

    return train_dataset, test_dataset, unlabelled_train_examples_test, vanilla_dataset
